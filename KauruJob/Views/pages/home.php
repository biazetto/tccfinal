...
<body>
	...
	<section class="main-feed">
		...
		<?php
			$retrievePosts = \KauruJob\Models\HomeModel::retrieveFriendsPosts();
		...
		<?php } ?>
    		...
    		<?php
		        foreach (\KauruJob\Models\UsuariosModel::listarAmizadesPendentes() as $key => $value) {
		          $usuarioInfo = \KauruJob\Models\UsuariosModel::getUsuarioById($value['enviou']);
		    ?>
