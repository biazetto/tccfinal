		...
		<div class="feed">
			...
			<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						<?php 
							foreach(\KauruJob\Models\UsuariosModel::listarAmigos() as $key => $value){ ?>
			...
			<br/>
				...
				<div class="container-comunidade">
					...
					<div class="container-comunidade-wraper">
						...
						<?php
							$comunidade = \KauruJob\Models\UsuariosModel::listarComunidade();
						...
						<div class="container-comunidade-single">
							...
							<div class="btn-solicitar-amizade">
								<?php
									if(\KauruJob\Models\UsuariosModel::existePedidoAmizade($value['id'])){
								?>
